...
export default function AIImageDescriberLayout({
  ...
  const jsonLd = {
    ...
    description: 'Free AI-powered image description tool that generates SEO-friendly alt text and detailed descriptions for any image. Perfect for improving website accessibility and search rankings.',
          url: 'https://policesketchmaker.it.com/ai-image-describer',
    ...
    potentialAction: {
      '@type': 'UseAction',
              target: 'https://policesketchmaker.it.com/ai-image-describer',
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Home',
                  item: 'https://policesketchmaker.it.com'
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'AI Image Describer',
                  item: 'https://policesketchmaker.it.com/ai-image-describer'
      }
    ]
  }
  ...
  const howToJsonLd = {
    ...
    description: 'Step-by-step guide to generate AI-powered image descriptions and alt text',
            image: 'https://policesketchmaker.it.com/icon.png',
    totalTime: 'PT2M',
    step: [
      {
        '@type': 'HowToStep',
