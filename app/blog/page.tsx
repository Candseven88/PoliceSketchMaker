...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://policesketchmaker.it.com/blog',
  },
  openGraph: {
    title: 'Police Sketch Maker Blog - How to Make Sketches & Learn Digital Art',
    description: 'Learn how to make sketch of face, create police sketches, and transform photos into professional sketches. Expert tips on sketch making techniques and digital art creation.',
    url: 'https://policesketchmaker.it.com/blog',
    type: 'website',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Police Sketch Maker Blog - Learn Sketch Making',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Police Sketch Maker Blog - Learn Sketch Making',
    description: 'Learn how to make sketch of face and create professional sketches with expert tutorials.',
...
const blogPosts = [
  {
    ...
    excerpt: 'Discover how AI photo editing is transforming creative workflows. Learn professional techniques, avoid common pitfalls, and master cutting-edge tools for stunning visual results.',
    image: '/blog/easy-sketching.jpg',
    date: '2024-01-18',
    category: 'AI Technology',
    slug: 'ai-photo-editing-revolution-professional-techniques'
  },
  {
    id: 2,
